	...
	<form id="accb-form" name="accb" action="#">
		<div class="tabs">
			<ul>
				...
				<li id="advanced_tab"><span><a href="javascript:mcTabs.displayTab('advanced_tab', 'advanced_panel');" onmousedown="return false;"><?php _e("Advance", 'advanced-code-button'); ?></a></span></li>
			</ul>
		</div>
		<div class="panel_wrapper">
			<div id="general_panel" class="panel current">
				<table border="0" cellpadding="4" cellspacing="0" style="width: 100%;">
					<tr>
						...
						<td>
							<select id="lang" name="lang" style="width: 200px">
								...
								<option value="apache"><?php _e("apache", 'advanced-code-button'); ?></option>
								<option value="applescript"><?php _e("applescript", 'advanced-code-button'); ?></option>
								...
								<option value="basic4gl"><?php _e("basic4gl", 'advanced-code-button'); ?></option>
								...
								<option value="gnuplot"><?php _e("gnuplot", 'advanced-code-button'); ?></option>
								...
								<option value="yaml"><?php _e("yaml", 'advanced-code-button'); ?></option>
					...
					<tr>
						<td nowrap="nowrap" valign="top"><label for="line_numbers"><?php _e("Show Line Number", 'advanced-code-button'); ?></label></td>
						<td><label><input name="line_numbers" id='line_numbers' type="checkbox" checked="checked" /></label></td>
					</tr>
					<tr>
			...
			<div id="style_panel" class="panel">
				<table border="0" cellpadding="4" cellspacing="0" style="width: 100%;">
					<tr>
						<td nowrap="nowrap" valign="top"><label for="theme"><?php _e("Theme", 'advanced-code-button'); ?></label></td>
						<td>
							<select id="theme" name="theme">
								<option selected="selected" value=""><?php _e("According to the settings", 'advanced-code-button'); ?></option>
								<option value="default">Slush &amp; Poppies</option>
								<option value="blackboard">Blackboard</option>
								<option value="dawn">Dawn</option>
								<option value="mac-classic">Mac Classic</option>
								<option value="twitlight">Twitlight</option>
								<option value="vibrant">Vibrant Ink</option>
								<option value="geshi">GeSHi</option>
								<option value="railscasts">Railscasts</option>
							</select>
						</td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="no_links"><?php _e("No Links", 'advanced-code-button'); ?></label></td>
						<td><label><input name="no_links" id='no_links' type="checkbox" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="inline"><?php _e("Inline", 'advanced-code-button'); ?></label></td>
						<td><label><input name="inline" id='inline' type="checkbox" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="nowrap"><?php _e("No Wrap", 'advanced-code-button'); ?></label></td>
						<td><label><input name="nowrap" id='nowrap' type="checkbox" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="noborder"><?php _e("No Border", 'advanced-code-button'); ?></label></td>
						<td><label><input name="noborder" id='noborder' type="checkbox" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="tab_size"><?php _e("Tab Size", 'advanced-code-button'); ?></label></td>
						<td><label><input name="tab_size" id='tab_size' type="text" maxlength="2" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="lines"><?php _e("Lines", 'advanced-code-button'); ?></label></td>
						<td><label><input name="lines" id='lines' type="text" maxlength="4" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="width"><?php _e("Width", 'advanced-code-button'); ?></label></td>
						<td><label><input name="width" id='width' type="text" maxlength="4" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="height"><?php _e("Height", 'advanced-code-button'); ?></label></td>
						<td><label><input name="height" id='height' type="text" maxlength="4" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="first_line"><?php _e("First Line", 'advanced-code-button'); ?></label></td>
						<td><label><input name="first_line" id='first_line' type="text" maxlength="4" /></label></td>
					</tr>
					<tr>
			...
			<div id="advanced_panel" class="panel">
				<table border="0" cellpadding="4" cellspacing="0" style="width: 100%;">
					<tr>
						<td nowrap="nowrap" valign="top"><label for="class"><?php _e("Class", 'advanced-code-button'); ?></label></td>
						<td><label><input name="class" id='class' type="text" maxlength="256" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="file"><?php _e("File", 'advanced-code-button'); ?></label></td>
						<td><label><input name="file" id='file' type="text" maxlength="256" /></label></td>
					</tr>
					<tr>
						<td nowrap="nowrap" valign="top"><label for="strict"><?php _e("Strict", 'advanced-code-button'); ?></label></td>
						<td><label><input name="strict" id='strict' type="checkbox" /></label></td>
					</tr>
				</table>
			</div>
		</div>
